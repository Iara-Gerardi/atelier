...
import exampleSearchTabStates from './mocks/ExampleSearchTab.mock'
...
export const registry: RegistryEntry[] = [
  ...
  { name: 'ExampleSearchTab', category: 'Are.na', tags: ['arena', 'discovery', 'search'], states: exampleSearchTabStates },
]
